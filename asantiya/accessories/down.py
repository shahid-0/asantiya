...
def down(
    name: Annotated[
        str, typer.Argument(help="Single or list of accessories name")
    ] = "all",
    volumes: Annotated[
        bool,
        typer.Option(
            "--volumes",
            "-v",
            help='Remove named volumes declared in the "volumes" section of the Yaml file and anonymous volumes attached to containers',
            is_flag=True,
            show_default="False",
        ),
    ] = False,
